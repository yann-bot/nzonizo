...
export default function Hero(){
    return(
        <div className=" flex lg:flex flex-col gap-2 justify-center items-center bg-orange-50 rounded-b-[50px] border-b border-gray-400 p-5">
            ...
            <div className="md:mt-10  w-2/3 flex gap-2 justify-center  ">
                <SearchForm />
                <Link href="/Recherche" ><button className="border p-2 bg-orange-500 text-white hover:bg-orange-700"> Rechercher </button></Link >
            </div>
